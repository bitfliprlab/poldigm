...
const baseMappings: Omit<ResultMapping, 'locale' | 'character_img'>[] = [
  ...
  },
  {
    ...
    desc_S:
      '당신은 사회 변화가 필요하다고 보며, 그 변화는 개인의 성과와 자율적인 참여가 만날 때 더 강해진다고 믿습니다. 새로운 실험과 협업을 적극적으로 받아들입니다.',
    desc_M:
  ...
  },
  {
    type_code: 'ITMO',
    title: '개인의 책임 전략가',
    subtitle: '각자의 성과와 질서 있는 경쟁을 신뢰합니다.',
    desc_S:
      '당신은 개인이 책임 있게 선택하고 성과로 인정받는 사회가 강하다고 봅니다. 전통적 안정감과 명확한 질서가 그 경쟁을 지탱한다고 믿는 성향입니다.',
    desc_M:
      '당신은 성과와 책임을 중시하지만, 경쟁이 모든 문제를 해결한다고 보지는 않습니다. 최소한의 보호와 예외적 조정도 필요하다고 느낍니다.',
    chemistry_best: 'CPML',
  ...
  },
  {
    ...
    desc_S:
      '당신은 개인의 성과와 자유가 사회를 움직이는 핵심 동력이라고 봅니다. 검증된 관습을 존중하지만, 국가나 조직이 개인의 선택을 과하게 대신하는 것은 경계합니다.',
    desc_M:
  ...
  },
  {
    ...
    desc_M:
      '당신은 혁신과 성과 중심의 보상을 선호하지만, 실험의 비용이 약한 사람에게 전가되는 상황은 경계합니다. 속도와 책임의 균형을 찾으려 합니다.',
    chemistry_best: 'CPMO',
